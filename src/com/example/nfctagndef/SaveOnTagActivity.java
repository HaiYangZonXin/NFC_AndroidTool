...
public class SaveOnTagActivity extends  Activity implements CreateNdefMessageCallback{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		System.out.print("\nonCreat\n");
		setContentView(R.layout.saveontag);
		textView= (TextView)this.findViewById(R.id.textViewSaveOnTag);
		Intent intent = getIntent();
		Bundle bundle =intent.getExtras();
		ReadFormIntent = bundle.getString("TxDat");
